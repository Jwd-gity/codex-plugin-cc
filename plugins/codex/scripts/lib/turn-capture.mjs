/**
 * Turn capture — manages the lifecycle of a single Codex turn.
 *
 * Creates a state object that collects notifications, tracks threads/subagents,
 * buffers early messages, and resolves a completion promise when the turn ends.
 *
...
export { captureTurn, emitProgress, shorten };
